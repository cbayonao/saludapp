...
export class CardMedicoComponent implements OnInit {
  public nombreMedico: string;
  public especialidades: [string, string];
  public sede: string;
  public bio: string;

  constructor() {
    this.nombreMedico = 'Maria Paez';
    this.especialidades = ['Pediatra', ' Cirugia Pediatra'];
    this.sede = 'Sede A';
    this.bio =
